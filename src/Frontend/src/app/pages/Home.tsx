              ...
              {token ? (
                ...
                <div className="flex items-center gap-2">
                  <motion.button
                    ...
                    className="px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl font-medium"
                    style={{ color: "white" }}
                  >
                    Iniciar sesión
                  </motion.button>
                  <motion.button
                    ...
                    className="px-4 py-2 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl font-medium"
                    style={{ color: "white" }}
                  >
                    Registrarse
                  </motion.button>
